module _01_getting_started._04_01_textures;
...
void _main()
{
    ...
    ShaderProgram shaderProgram = new ShaderProgram(
        "shaders/_01_getting_started/_04_01_shaders/vertex_shader.vs",
        "shaders/_01_getting_started/_04_01_shaders/fragment_shader.fs"
    );
    ...
    try
    {
        ...
        height = img.height;
        pixels = img.data;
        format = (img.channels == 4) ? GL_RGBA : GL_RGB; // Determina o formato da imagem
